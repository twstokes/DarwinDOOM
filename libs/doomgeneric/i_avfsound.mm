//
// AVFoundation-backed sound module for iOS/watchOS/macOS.
// Provides DG_sound_module for FEATURE_SOUND builds on Apple platforms.
//
...
#if TARGET_OS_WATCH || TARGET_OS_IOS || TARGET_OS_OSX
